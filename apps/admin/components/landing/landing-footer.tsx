        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-md leading-relaxed">
              Subscription-based loan operations for licensed money lenders in Malaysia — staff-led
              origination, multi-tenant admin, servicing, optional TrueIdentity and TrueSend modules, and
              compliance-oriented exports. No online self-serve loan pipeline on Core.
            </p>
