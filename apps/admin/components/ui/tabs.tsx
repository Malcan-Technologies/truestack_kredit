...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md p-1 bg-secondary text-muted-foreground overflow-hidden",
      className
    )}
    {...props}
  />
