        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-wrap items-center gap-4 p-4 rounded-lg border border-border bg-secondary">
            ...
            <CardContent className="pt-0 space-y-3">
              <div className="rounded-md border border-border">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between gap-4 px-3 py-2.5 border-b border-border last:border-b-0"
                  >
...
Interest Rate: ${calculation.interestRate}% p.a. (${calculation.interestModel === "FLAT" ? "Flat" : calculation.interestModel === "RULE_78" ? "Rule 78" : "Reducing Balance"})
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1 mt-1">
                              <Badge variant="outline" className="text-xs">
                                {product.interestModel === "FLAT" ? "Flat Rate" : product.interestModel === "RULE_78" ? "Rule 78" : "Reducing Balance"}
                              </Badge>
                              <Badge
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-right">
                        ...
                        <Badge variant="outline" className="ml-2 text-xs">
                          {calculation.interestModel === "FLAT" ? "Flat" : calculation.interestModel === "RULE_78" ? "Rule 78" : "Reducing"}
                        </Badge>
                      </TableCell>
                    </TableRow>
                    <TableRow>
