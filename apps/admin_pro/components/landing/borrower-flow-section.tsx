...
export function BorrowerFlowSection() {
  return (
    <SectionShell id="borrower-flows" variant="muted">
      <SectionHeading
        title="Individual and company borrowers — one platform, different rigour"
        description="Origination and servicing respect the difference between natural persons and corporate structures, so your team doesn’t dilute checks or duplicate systems."
      />
