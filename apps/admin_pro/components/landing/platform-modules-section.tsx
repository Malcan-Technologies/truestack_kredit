...
export function PlatformModulesSection() {
  return (
    <SectionShell id="platform">
      <SectionHeading
        title="Everything your lending team runs day to day"
        description="Modular surfaces for origination, servicing, identity, communications, and the admin work that holds it together — without mixing borrower marketing language into your internal operations."
      />
