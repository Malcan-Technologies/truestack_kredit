...
/** Malaysia and common regional countries first, then rest alphabetically */
...
/** Input without border - used inside the phone input wrapper */
...
>(({ className, ...props }, ref) => (
  <Input
    ref={ref}
    className={cn("border-0 shadow-none focus-visible:ring-0 px-0", className)}
    {...props}
  />
));
