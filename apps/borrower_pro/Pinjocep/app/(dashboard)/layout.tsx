...
export default function DashboardLayout({
  ...
  /** Attestation / scheduling items needing borrower action (e.g. counter-proposed, post-meeting confirm). */
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (cancelled) return;
        // Do not show the yellow banner on fetch errors — avoids a false "set up security" nudge
        // when the user may already have 2FA or a passkey.
        setSecurityStatus("complete");
      }
    })();
