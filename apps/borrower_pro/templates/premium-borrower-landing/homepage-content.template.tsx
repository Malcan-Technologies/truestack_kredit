...
/**
 * Premium borrower landing — copy into `app/homepage-content.tsx` for a new tenant.
 * See `README.md` in this folder for wiring steps (legal module, footer, hero asset).
 * Snapshot source: Pinjocep/app/homepage-content.tsx
 */
...
function HomeLoanCalculator({ lenderName }: { lenderName: string }) {
      ...
      <CardHeader className="space-y-3">
        ...
        <div>
          ...
          <CardDescription className="mt-2">
            Enter your income and commitments to see an indicative monthly repayment.
          </CardDescription>
        </div>
      </CardHeader>
...
export function HomePageContent() {
  ...
  const faqs = useMemo((): { question: string; answer: ReactNode }[] => [
    ...
    },
    {
      ...
      answer: (
        <>
          We use industry-standard security and PDPA-compliant data handling. Read our{" "}
          <LegalNavLink
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-start">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Enter your income and existing commitments to see an indicative monthly repayment.
                Final figures are confirmed after your assessment.
              </p>
            ...
            <HomeLoanCalculator lenderName={lender.lenderName} />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
            <Accordion type="single" collapsible className="w-full divide-y divide-border rounded-xl border border-border/70 bg-background px-2">
              {faqs.map((item) => (
                <AccordionItem key={item.question} value={item.question} className="border-0 first:border-0">
            ...
            <Card className="border-border/70 bg-primary/5 h-fit">
              ...
              <CardContent className="space-y-3">
                <Button asChild className="w-full">
                  <Link href="/sign-up">Apply Now — It&apos;s Free</Link>
                </Button>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <p className="max-w-xl text-primary-foreground/80">
              Join Malaysians who trust {lender.lenderName} for their financial needs. Apply today and get funded within 24 hours.
            </p>
