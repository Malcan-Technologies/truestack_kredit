...
Learn how to create, view, and manage borrower records in TrueKredit. Borrower management is essential for compliance and efficient loan processing.
...
- Create and maintain borrower profiles for individuals and businesses
- Store compliance-required information
- Track borrower activity and changes
...
No, IC numbers must be unique within your tenant. The system will reject duplicate IC numbers.
