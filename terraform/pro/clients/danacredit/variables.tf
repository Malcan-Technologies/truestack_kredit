...
variable "dedicated_vpc_cidr" {
  type        = string
  description = "IPv4 CIDR for the client VPC when networking_mode=dedicated. Must not overlap other VPC CIDRs in this account."
...
variable "email_from_address" {
  type    = string
  default = "no-reply@danacredit.my"
}
